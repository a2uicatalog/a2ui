    ...
    return {
        "linkset": [{
            ...
            "describes": [
                ...
                item(f"{BASE}/agents.md", "text/markdown", "Agent integration guide and tool reference"),
                item(f"{BASE}/llms.txt", "text/markdown", "Agent-facing catalogue overview (llms.txt)"),
                item(f"{BASE}/.well-known/agent-auth.md", "text/markdown", "Authentication and rate limits guide"),
            ],
        }],
    }
