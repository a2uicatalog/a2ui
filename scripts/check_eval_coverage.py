...
KNOWN_UNCOVERED_BASELINE = frozenset({
    ...
    "calibration_plot",
    # Added 2026-09-25: atoms with no routing-eval targets in this checkout's eval fixture (44 at the time).
    # A known gap, not an accepted one. Remove each once `ops.py run atom-multirep-onboard` covers it.
    "actual_vs_estimate",
    "agent_sketchpad",
    "changed_mind",
    "content_tabs",
